  ...
  <view v-if="!isLogin" class="denied-container">
    <view class="content">
      ...
      <view class="text-section">
        <text class="main-title">Log in to view orders</text>
        <text class="sub-desc">Track your order history and status by signing in to your account.</text>
      </view>
    ...
    <view v-if="orders.length === 0" class="empty-container">
      <view class="content">
        ...
        <view class="text-group">
          <text class="main-title">No Orders Yet</text>
          <text class="sub-title"> Looks like you haven't placed any orders. Discover delicious food near you!</text>
        </view>
        <!-- 3. 操作按钮 -->
        <button class="explore-btn" @click="goHome">Explore Food</button>
      </view>
    </view>
...
const goToDetail = (id) => {
  uni.navigateTo({ url: `/packageOrder/OrderDetailPage/OrderDetailPage?id=${id}` });
};
